...
const Pantiesslider = (props) => {
  ...
  const gridmenu = localStorage.getItem('pantiesgrid')

  return (
    <div className='Pantiesproducts '>

      <Slider className={`${gridmenu === 'true' ? 'non-sliderrr' : 'sliderr'}`} {...settings}>
        <div className='Panties-product'>
