...
const Pajamaslider = (props) => {
  ...
  const gridmenu = localStorage.getItem('pajamagrid')

  return (
    <div className='Pajamasproducts '>

      <Slider className={`${gridmenu === 'true' ? 'non-sliderrr' : 'sliderr'}`}  {...settings}>
        <div className='Pajamas-product'>
